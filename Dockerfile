...
ENV VIRTUAL_ENV /opt/Trabalho_Mecanica_dos_solidos-env
ENV PATH $VIRTUAL_ENV/bin:$PATH
RUN python -m venv $VIRTUAL_ENV

# Set the working directory.
WORKDIR /workspaces/Trabalho_Mecanica_dos_solidos/
...
COPY --chown=user:user poetry.lock* pyproject.toml /workspaces/Trabalho_Mecanica_dos_solidos/
RUN mkdir -p /home/user/.cache/pypoetry/ && mkdir -p /home/user/.config/pypoetry/ && \
    mkdir -p src/trabalho_mecanica_dos_solidos/ && touch src/trabalho_mecanica_dos_solidos/__init__.py && touch README.md
...
COPY --chown=user:user .pre-commit-config.yaml /workspaces/Trabalho_Mecanica_dos_solidos/
